  ...
  const successStories = [
    {
      ...
      description: "A leading retail brand witnessed significant growth in brand awareness and engagement through tailored campaigns that captured their brand essence while reaching the desired audience.",
      metrics: {
        traffic: "+30%",
        conversion: "+25%",
        roi: "400%"
    ...
    },
    {
      ...
      description: "A tech startup successfully launched a new product, observing remarkable improvements in customer acquisition through our targeted advertising approach and strategic banner placement.",
      metrics: {
        leads: "+180%",
        signups: "+90%",
        roi: "350%"
    ...
    },
    {
      ...
      timeframe: "6 months",
      description: "A healthcare provider transformed their patient outreach strategy, achieving unprecedented growth in patient consultations and appointment bookings through targeted banner campaigns.",
      metrics: {
        patients: "+45%",
        appointments: "+60%",
        roi: "280%"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
            Success Stories with PublifyX
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            PublifyX has played a pivotal role in transforming the digital marketing strategies 
            of numerous businesses through advanced banner advertising solutions.
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <div className="flex items-center space-x-4 text-orange-500 font-semibold">
                    <TrendingUp className="w-5 h-5" />
                    <span>{currentStoryData.result} in {currentStoryData.timeframe}</span>
                  </div>
                </div>
              ...
              <div className="relative">
                <div className={`bg-gradient-to-br ${currentStoryData.color} rounded-2xl p-8 text-white shadow-2xl transform transition-all duration-500`}>
                  ...
                  <div className="mt-8 p-4 bg-white/10 rounded-lg backdrop-blur-sm">
                    <p className="text-sm italic">
                      "PublifyX transformed our advertising strategy and delivered results 
