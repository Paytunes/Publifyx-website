        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                >
                  ...
                  {isSelected && (
                    <div className="mt-4 p-4 bg-white rounded-lg shadow-sm">
                      <div className="text-sm text-orange-500 font-semibold">{feature.mockup}</div>
                    </div>
                  )}
                </div>
              );
          ...
          >
            <div className="relative">
              ...
              {/* Floating Elements */}
              <div className="absolute -top-4 -right-4 bg-orange-600 text-white px-3 py-2 rounded-full shadow-lg animate-bounce">
