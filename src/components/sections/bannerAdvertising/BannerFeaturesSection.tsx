...
const BannerFeaturesSection = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Integrate with various digital channels to ensure your banner ads achieve broad visibility across multiple platforms and maximize your reach.",
    ...
    },
    {
      icon: Headphones,
      title: "24/7 Support",
      description: "Our dedicated support team is available around the clock to assist with any queries and ensure you leverage our tools to their fullest potential.",
      mockup: "👥 Support Team",
      color: "bg-orange-500"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
            PublifyX's Exclusive Features
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            PublifyX distinguishes itself in the banner advertising landscape with exclusive features 
            designed to optimize your campaigns and maximize impact.
          </p>
        </div>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-orange-50 rounded-2xl p-8 shadow-2xl">
                <div className="text-center mb-8">
                  ...
                  <div className="text-4xl mb-4">
                    {features[selectedFeature].mockup}
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  {selectedFeature === 2 && (
                    ...
                    <div className="flex justify-center items-center space-x-4">
                      ...
                      <div className="w-12 h-12 bg-red-500 rounded-lg flex items-center justify-center text-white font-bold">G</div>
                      <div className="w-12 h-12 bg-purple-500 rounded-lg flex items-center justify-center text-white font-bold">IG</div>
                      <div className="w-12 h-12 bg-green-500 rounded-lg flex items-center justify-center text-white font-bold">WA</div>
                    </div>
                  )}
                  ...
                  {selectedFeature === 3 && (
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1 bg-orange-100 rounded-lg p-3 text-sm">
