  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-br from-gray-light via-white to-orange-50 relative overflow-hidden">
      ...
      {floatingElements.map((element) => (
        ...
        >
          <div className="w-16 h-10 bg-orange-600 rounded-lg shadow-lg flex items-center justify-center opacity-20">
          ...
          >
            ...
            <h1 className="mb-6 text-4xl md:text-6xl font-bold text-gray-800 leading-tight">
              ...
              <span className="text-orange-500 relative">
                ...
                <div className="absolute -bottom-2 left-0 w-full h-1 bg-orange-600 opacity-30 rounded"></div>
              </span>
            </h1>
            ...
            <div className="mb-8">
              <Button
                ...
                className="bg-orange-600 hover:bg-orange-700 text-white px-8 py-4 rounded-lg font-bold text-lg transition-all duration-200 hover:scale-105 shadow-lg group"
              >
