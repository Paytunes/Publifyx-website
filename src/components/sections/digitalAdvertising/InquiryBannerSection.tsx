...
const InquiryBannerSection = () => {
  return (
    <section className="py-12 bg-gradient-to-r from-purple-primary via-purple-600 to-purple-700">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-white">
            ...
            <p className="text-xl text-purple-50 mb-8 leading-relaxed">
              Get personalized recommendations and exclusive rates from our digital advertising experts. We'll help you
              choose the perfect platforms for your target audience.
            </p>
          ...
          <div className="relative">
            <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-10 border border-white/20 shadow-2xl">
              <div className="text-center mb-8">
                ...
                <h3 className="text-3xl font-bold text-white mb-3">Data-Driven Results</h3>
