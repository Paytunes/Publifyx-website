        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center bg-gray-50 p-8 rounded-lg">
            <p className="text-lg text-gray-700 mb-6">
              Today is the perfect time for your brand to adapt Smart TV advertising. Expect your brands to run smarter,
              richer, and better-looking campaigns with Smart TV advertising with connected TV ads by PublifyX.
            </p>
            <Button
