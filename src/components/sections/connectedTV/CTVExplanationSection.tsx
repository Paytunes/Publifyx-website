          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Connected TV (CTV) advertising lets your brand show video ads on internet-enabled TVs—think Smart TVs,
                Roku, Fire TV, Apple TV, even gaming consoles.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Unlike traditional cable ads that interrupt random content, CTV ads appear within on-demand,
                high-quality, and premium environments—exactly where today's viewer is.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Advertisers can easily target real people and will be able to track real results, which is something you
                don't get with traditional cable advertising.
              </p>
            </div>
          </div>
