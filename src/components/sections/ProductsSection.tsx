...
const ProductsSection = () => {
  ...
  return (
    <section className="py-12 md:py-16 bg-navy-800 relative overflow-hidden below-fold">
      <div className="absolute top-0 right-0 w-96 h-96 bg-brand-orange-500 rounded-full blur-[200px] opacity-10" aria-hidden="true" />
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-brand-orange-400 rounded-full blur-[160px] opacity-[0.06]" aria-hidden="true" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16" ref={headingRef}>
          <span className="reveal inline-block text-sm font-semibold text-brand-orange-400 uppercase tracking-widest mb-3">
            Products
          </span>
          <h2 className="reveal reveal-delay-1 mb-4 !text-white">Choose Your Plan</h2>
          <p className="reveal reveal-delay-2 text-lg text-navy-300 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8" ref={gridRef}>
          {/* Shout Lite */}
          <div className="reveal reveal-delay-1 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 flex flex-col justify-between hover:bg-white/10 hover:border-white/20 transition-all duration-500 group">
            <div>
              <div className="w-12 h-12 rounded-xl bg-brand-orange-500/20 flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300">
                <Zap className="w-6 h-6 text-brand-orange-400" aria-hidden="true" />
              </div>
          ...
          {/* Shout Enterprise */}
          <div className="reveal reveal-delay-2 bg-gradient-to-br from-brand-orange-500 to-brand-orange-600 rounded-2xl p-8 flex flex-col justify-between shadow-xl shadow-brand-orange-500/20 relative group hover:shadow-2xl hover:shadow-brand-orange-500/30 transition-shadow duration-500">
