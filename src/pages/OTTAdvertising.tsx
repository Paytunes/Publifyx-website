...
const features = [
  ...
  },
  {
    ...
    description: "Access ad-supported streaming platforms, FAST channels, and OTT apps through leading SSP integrations and private marketplace deals.",
    icon: Globe,
  },
  {
  ...
  },
  {
    ...
    description: "Monitor campaign performance in real time with metrics including impressions, VCR, reach, frequency, and cost efficiency. Make adjustments on the fly to improve results.",
    icon: BarChart3,
  },
  {
...
const OTTAdvertising = () => {
  useEffect(() => {
    ...
    return () => {
      ...
      const el = document.getElementById("ott-faq-schema");
      if (el) el.remove();
    };
  }, []);
  ...
  return (
    <Layout transparentHeader>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <p className="text-base font-semibold text-navy-700 mb-4">OTT content is consumed across:</p>
              ...
              <div className="bg-navy-50 rounded-2xl border border-navy-100 p-6 mb-6">
                <p className="text-base font-semibold text-navy-800 mb-2">The distinction is simple:</p>
            ...
            >
              <div className="relative">
                ...
                <img
                  src={ottMultiscreen}
                  alt="OTT advertising across multiple screens including smart TV, smartphone, tablet, and laptop"
                  className="relative w-full h-auto rounded-2xl shadow-2xl border border-navy-100"
                  loading="lazy"
                  decoding="async"
                />
              </div>
      ...
      {/* ─── 5. PUBLIFYX OTT ADVERTISING CAPABILITIES ─── */}
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {features.map((feature, i) => (
              ...
              >
                <div className="bg-navy-50 rounded-2xl border border-navy-100 p-8 h-full hover:shadow-xl hover:shadow-navy-500/5 transition-all duration-300 group">
                  <div className="w-14 h-14 rounded-2xl bg-navy-800 flex items-center justify-center mb-5 group-hover:bg-brand-orange-500 transition-colors duration-300 shadow-lg shadow-navy-900/20">
                    <feature.icon className="w-7 h-7 text-brand-orange-400 group-hover:text-white transition-colors" />
                  </div>
              ...
              return (
                ...
                >
                  <div className="w-full md:w-1/2">
                    <div className="relative rounded-2xl overflow-hidden shadow-xl border border-navy-100">
                      <img
                        src={format.image}
                        alt={`${format.title} - OTT advertising format`}
                  ...
                  <div className="w-full md:w-1/2">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-11 h-11 rounded-xl bg-brand-orange-500 flex items-center justify-center shadow-lg shadow-brand-orange-500/20">
                        <span className="text-white font-black text-base">{String(i + 1).padStart(2, "0")}</span>
                      </div>
                      <h3 className="font-extrabold text-navy-800 text-xl">{format.title}</h3>
                    </div>
      ...
      {/* ─── 9. HELPFUL OTT & CTV CONTENT FOR MARKETERS ─── */}
      <OTTResourceSection />
    </Layout>
  );
};
