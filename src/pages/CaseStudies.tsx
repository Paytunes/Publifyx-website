...
import { ArrowRight, Sparkles, TrendingUp, Users, Zap, CheckCircle2, Building2, Globe, Star, Target } from "lucide-react";
...
const cases = [
  {
    ...
    solution: "The agency deployed PublifyX as a white label DSP under their own brand with custom domain, branding, and preferred SSP integrations.",
    results: ["Eliminated third-party DSP fees, increasing margins", "Improved client retention with branded platform", "Expanded to include CTV and audio advertising"],
  },
  {
    icon: Zap,
    title: "Ad Tech Startup Enters the Market in Two Weeks",
    challenge: "A startup team with ad tech experience wanted to launch their own DSP but lacked the capital and time to build from scratch.",
    ...
    results: ["Launched DSP within two weeks with display, video, and audio", "Onboarded first advertisers in the first month", "Reached profitability within the first quarter"],
  },
  {
    icon: Users,
    title: "Ad Network Adds Self-Serve Programmatic",
    challenge: "An established ad network wanted to offer self-serve programmatic buying capabilities but building a DSP internally would take too long.",
    solution: "The network integrated PublifyX as a white-labeled self-serve platform accessible to their advertisers.",
    results: ["Added new revenue stream through platform fees", "Improved advertiser satisfaction with self-serve", "Differentiated from competing networks"],
  },
];

const whoItsFor = [
  { title: "Media Agencies", description: "See how agencies eliminate third-party fees and present clients with their own branded platform.", icon: Building2 },
  { title: "Ad Networks", description: "Learn how networks add self-serve programmatic as a new revenue stream for their advertisers.", icon: Globe },
  { title: "Startups", description: "Discover how startups launch profitable DSPs in weeks without millions in development costs.", icon: Star },
  { title: "Performance Teams", description: "Explore how data-driven teams achieve better ROI with advanced targeting and optimization.", icon: Target },
];
...
const CaseStudies = () => {
  ...
  useEffect(() => {
    ...
    if (meta) meta.setAttribute("content", "See how agencies, ad networks, and startups use PublifyX white label DSP to launch their own programmatic platforms.");
  ...
  return (
    <Layout transparentHeader>
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-navy-800">
        ...
        <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-brand-orange-300 rounded-full blur-[160px] opacity-[0.06]" />
         <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <PageBreadcrumb items={[{ label: "Home", path: "/" }, { label: "Resources", path: "/resources" }, { label: "Case Studies" }]} />
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
              ...
              <p className="text-lg md:text-xl text-navy-200 mb-4 leading-relaxed max-w-xl">
                Every PublifyX client has a unique story. What they share is a common outcome: faster market entry, increased margins, and stronger client relationships.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-start mb-10">
                <Button onClick={handleGetStarted} className="bg-brand-orange-500 hover:bg-brand-orange-600 text-white px-10 py-6 rounded-xl font-semibold text-lg transition-all duration-300 hover:scale-105 shadow-lg shadow-brand-orange-500/25 group">
                  Write Your Success Story <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </Button>
              </div>
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <motion.span initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="inline-block text-sm font-semibold text-brand-orange-500 uppercase tracking-widest mb-3">Client Stories</motion.span>
            <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>How Businesses Grow with PublifyX</motion.h2>
          </div>
              ...
              <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}>
                <div className="bg-navy-50 border border-navy-100 rounded-2xl overflow-hidden hover:shadow-lg transition-shadow">
                  ...
                  <div className="p-6 md:p-8 grid md:grid-cols-3 gap-6">
                    <div>
                      <h4 className="text-xs font-bold uppercase tracking-widest text-brand-orange-500 mb-2">Challenge</h4>
                      <p className="text-navy-600 text-sm leading-relaxed">{cs.challenge}</p>
                    </div>
                    <div>
                      <h4 className="text-xs font-bold uppercase tracking-widest text-brand-orange-500 mb-2">Solution</h4>
                      <p className="text-navy-600 text-sm leading-relaxed">{cs.solution}</p>
                    </div>
                    <div>
                      <h4 className="text-xs font-bold uppercase tracking-widest text-brand-orange-500 mb-2">Results</h4>
      ...
      <section className="py-20 md:py-28 bg-navy-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <motion.span initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="inline-block text-sm font-semibold text-brand-orange-500 uppercase tracking-widest mb-3">Your Industry</motion.span>
            <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>Results for Every Business Type</motion.h2>
          </div>
      ...
      <section className="py-20 md:py-28 bg-navy-800 relative overflow-hidden">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl text-navy-300 mb-4 leading-relaxed">Join agencies, ad networks, and startups that have transformed their business with PublifyX.</p>
          <p className="text-base text-navy-400 mb-10 font-semibold">No commitment required · Schedule a consultation</p>
