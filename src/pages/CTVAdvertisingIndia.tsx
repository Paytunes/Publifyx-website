...
const features = [
  {
    title: "Premium Indian Audiences",
    description:
      "CTV viewers in India are urban, affluent, and digitally savvy — a high-value segment for FMCG, auto, electronics, and more.",
    icon: Users,
  },
  {
    title: "Non-Skippable Full-Screen",
    description:
      "CTV ads deliver immersive, full-screen experiences with completion rates significantly higher than mobile video.",
    icon: Tv,
  },
  {
  ...
  },
  {
    ...
    description:
      "Access inventory across JioCinema, Disney+ Hotstar, SonyLIV, ZEE5, and more through SSP integrations.",
    icon: Globe,
  },
];
...
const steps = [
  {
    number: "01",
    title: "Define India Strategy",
    description: "Set objectives and targeting criteria for the Indian market.",
    icon: PhoneCall,
  },
  {
    number: "02",
  ...
  },
  {
    ...
    description: "Go live across Indian CTV inventory via programmatic buying.",
    icon: Rocket,
  },
  {
    number: "04",
...
const faqs = [
  {
    question: "Is CTV advertising available in India?",
    answer:
      "Yes. CTV advertising is available through PublifyX. With growing smart TV adoption and ad-supported streaming, CTV inventory in India is expanding rapidly.",
  },
  {
    question: "Which streaming platforms support CTV ads in India?",
    answer:
      "Several Indian streaming platforms offer ad-supported content. Available inventory varies by SSP integrations and platform partnerships.",
  },
  {
    question: "How is CTV different from mobile OTT in India?",
    answer:
      "CTV is ads on TV screens via internet-connected devices. Mobile OTT is streaming on smartphones. CTV provides a larger, more immersive experience with higher completion rates.",
  },
  {
    question: "Can I target specific cities in India?",
    answer:
      "Yes. PublifyX supports geographic targeting at state, city, and pin code level for CTV campaigns in India.",
  },
];
...
const CTVAdvertisingIndia = () => {
  useEffect(() => {
    ...
    if (meta)
      meta.setAttribute(
        "content",
        "Launch CTV advertising campaigns in India with PublifyX. Reach smart TV audiences across Indian streaming platforms.",
      );
    return () => {
