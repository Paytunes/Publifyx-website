...
const serviceSchema = {
  ...
  "description": "Launch your own branded white label DSP in 15 minutes with PublifyX. Multi-channel programmatic buying across Display, Video, Audio, CTV and OTT. No coding required.",
...
const softwareAppSchema = {
  ...
  "description": "A fully branded white label demand side platform enabling agencies, ad networks and startups to launch their own programmatic advertising platform.",
  "publisher": {
    "@type": "Organization",
    "name": "PublifyX"
  },
...
const reviewSchema = {
  "@context": "https://schema.org",
  "@type": "Review",
  "reviewBody": "Launching our own branded DSP completely changed how clients perceive us. The transition was smooth and we were live within minutes.",
  "author": {
    "@type": "Person",
