...
import pricingDashboard from "@/assets/pricing/hero-dashboard.webp";
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative">
                ...
                <img
                  src={pricingDashboard}
                  alt="Pricing plans dashboard showing tier comparison, cost calculator, and ROI projection charts"
