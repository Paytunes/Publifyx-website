...
import integrationsDashboard from "@/assets/integrations/hero-dashboard.webp";
...
const integrationTypes = [
  {
    ...
    description:
      "Leading SSPs aggregating inventory from premium publishers, apps, and streaming platforms. Billions of daily impressions across all major formats.",
    icon: Network,
  },
  {
    title: "Ad Exchanges",
    description:
      "Real-time bidding inventory through major exchanges. Open auction, private marketplace (PMP), and programmatic guaranteed deals.",
    icon: Globe,
  },
  {
    title: "Data Partners",
    description:
      "Third-party audience data from leading providers. Demographic, behavioral, interest-based, and intent-based segments.",
    icon: Database,
  },
  {
    title: "Custom Integrations",
    description:
      "Have existing supply partners or data providers? Our team configures custom integrations for your platform.",
    icon: Settings,
  },
];
...
const channelCoverage = [
  {
    ...
    description: "Hundreds of thousands of websites and mobile apps through leading exchanges.",
    icon: Monitor,
  },
  {
    title: "Video Inventory",
    description: "In-stream and outstream placements across premium publishers and streaming platforms.",
    icon: Video,
  },
  {
    title: "Audio Inventory",
    description: "Streaming music, podcast networks, digital radio, and smart speaker environments.",
    icon: Headphones,
  },
  {
    title: "CTV & OTT Inventory",
    description: "Smart TVs, streaming devices, FAST channels, and ad-supported OTT apps.",
    icon: Tv,
  },
];
...
const whoItsFor = [
  {
    ...
    description:
      "Access the broadest inventory across all channels with a single platform login and unified reporting.",
    icon: Building2,
  },
  {
    title: "Ad Networks",
    description: "Offer your advertisers premium programmatic inventory through custom supply partnerships.",
    icon: Globe,
  },
  {
    title: "Startups",
    description: "Launch with 40+ pre-configured integrations — no need to negotiate supply deals from scratch.",
    icon: Star,
  },
  {
    title: "Performance Teams",
    description: "Optimize across multiple supply sources for the best performance at the lowest cost.",
    icon: Target,
  },
];
...
const Integrations = () => {
  useEffect(() => {
    ...
    if (meta)
      meta.setAttribute(
        "content",
        "PublifyX integrates with 40+ SSPs, ad exchanges, and data partners. Access premium inventory across display, video, audio, CTV, and OTT.",
      );
    return () => {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
              ...
              <p className="text-lg md:text-xl text-navy-200 mb-4 leading-relaxed max-w-xl">
                The value of a DSP depends on its supply connections. PublifyX integrates with 40+ SSPs, ad exchanges,
                and data partners for premium inventory worldwide.
              </p>
            ...
            >
              <div className="relative">
                ...
                <img
                  src={integrationsDashboard}
                  alt="SSP and ad exchange integrations network dashboard showing connected supply partners and API status"
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              Who Benefits from Our Integrations?
            </motion.h2>
          </div>
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
      ...
      <section className="py-12 md:py-16 bg-navy-800 relative overflow-hidden">
        ...
        >
          ...
          <p className="text-xl text-navy-300 mb-4 leading-relaxed">
            Need a specific supply partner or data integration? Our team can configure custom connections.
          </p>
          <p className="text-base text-navy-400 mb-10 font-semibold">
            No commitment required · Custom integrations available
          </p>
          <EnergyButton className="inline-flex items-center btn-primary text-lg px-10 py-4">
            <Link to="/contact" className="flex items-center text-white no-underline group">
              Book a Call{" "}
