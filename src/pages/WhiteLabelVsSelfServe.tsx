...
const comparisons = [
  {
    factor: "Branding",
    selfServe: "Provider's brand",
    whiteLabel: "Your brand exclusively",
    icon: Palette,
  },
  {
    factor: "Pricing Control",
    selfServe: "Provider's published rates",
    whiteLabel: "You set your own pricing",
    icon: DollarSign,
  },
  {
    factor: "Supply Partnerships",
    selfServe: "Pre-configured sources",
    whiteLabel: "Custom SSP integrations",
    icon: Network,
  },
  {
    factor: "Client Access",
    selfServe: "One level of access",
    whiteLabel: "Custom access tiers",
    icon: Users,
  },
  {
    factor: "Cost Structure",
    selfServe: "% of spend (grows with scale)",
    whiteLabel: "Fixed/tiered (more cost-effective)",
    icon: TrendingUp,
  },
  {
    factor: "Time to Market",
    selfServe: "Immediate access",
    whiteLabel: "1-2 weeks setup",
    icon: Clock,
  },
];
...
const whoItsFor = [
  {
    title: "Agencies",
    description:
      "Choose white label if you want to brand the platform, control margins, and build client relationships around proprietary technology.",
    icon: Building2,
  },
  {
    title: "Ad Networks",
    description:
      "White label lets you offer self-serve programmatic under your brand with custom access for different advertiser tiers.",
    icon: Globe,
  },
  {
    title: "Startups",
    description:
      "Start with white label for a differentiated market entry — your own branded DSP from day one.",
    icon: Star,
  },
  {
    title: "Solo Advertisers",
    description:
      "Self-serve DSP may work if you need quick, no-setup access without branding or client features.",
    icon: Target,
  },
];
...
const faqs = [
  {
    question: "Can a white label DSP also offer self-serve access?",
    answer:
      "Yes. White label refers to branding and ownership. Self-serve describes the user experience. You can configure white label for self-serve client access.",
  },
  {
    question: "Is a white label DSP more expensive?",
    answer:
      "Not necessarily. White label DSPs avoid percentage-based spend markups. At higher volumes, white label often becomes more cost-effective.",
  },
  {
    question: "Can I switch from self-serve to white label?",
    answer:
      "Yes. Many businesses start self-serve and transition to white label as branding, margin control, and client access needs grow.",
  },
];
...
const WhiteLabelVsSelfServe = () => {
  useEffect(() => {
    document.title =
      "White Label DSP vs Self-Serve DSP: Which Is Right for You? — PublifyX";
    const meta = document.querySelector('meta[name="description"]');
    if (meta)
      meta.setAttribute(
        "content",
        "Understand the key differences between a white label DSP and a self-serve DSP. Compare features, costs, control, and scalability.",
      );
    return () => {
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <PageBreadcrumb
            items={[
              { label: "Home", path: "/" },
              { label: "Resources" },
              { label: "White Label vs Self-Serve" },
            ]}
          />
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg md:text-xl text-navy-200 mb-4 leading-relaxed max-w-xl">
                Both provide programmatic ad buying, but they differ
                significantly in branding, control, cost structure, and
              ...
              <p className="text-sm text-navy-400">
                Not sure? Talk to our team for a personalized recommendation
              </p>
            </div>
          ...
          >
            <div className="bg-white rounded-2xl border border-navy-100 p-8">
              ...
              <p className="text-navy-400 text-sm mb-6 leading-relaxed">
                Best for individual advertisers or small teams needing quick,
                no-setup access without branding requirements.
              </p>
            ...
            <div className="bg-navy-800 rounded-2xl border border-navy-700 p-8">
              ...
              <p className="text-navy-300 text-sm mb-6 leading-relaxed">
                Best for agencies, networks, and startups wanting branded
                programmatic capabilities with margin control.
              </p>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={item} className="flex items-center gap-3">
                    ...
                    <span className="text-navy-200 font-medium text-sm">
                      {item}
                    </span>
                  </li>
                ))}
      ...
      <section className="py-12 md:py-16 bg-navy-800 relative overflow-hidden">
        ...
        >
          ...
          <p className="text-xl text-navy-300 mb-4 leading-relaxed">
            Not sure which approach fits your business? Talk to our team for a
