...
const whoItsFor = [
  ...
  {
    title: "Startups",
    description: "Start with white label for a differentiated market entry — your own branded DSP from day one.",
    icon: Star,
  },
  {
    title: "Solo Advertisers",
    description: "Self-serve DSP may work if you need quick, no-setup access without branding or client features.",
    icon: Target,
  },
];
    ...
    <Layout transparentHeader>
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-navy-800">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <PageBreadcrumb
            items={[{ label: "Home", path: "/" }, { label: "Resources" }, { label: "White Label vs Self-Serve" }]}
          />
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
              ...
              <p className="text-lg md:text-xl text-navy-200 mb-4 leading-relaxed max-w-xl">
                Both provide programmatic ad buying, but they differ significantly in branding, control, cost structure,
                and long-term scalability.
              </p>
              <p className="text-base text-navy-300 mb-10 font-semibold">Branding · Margins · Control · Scalability</p>
          ...
          >
            <div className="bg-white rounded-2xl border border-navy-100 p-8">
              ...
              <p className="text-navy-400 text-sm mb-6 leading-relaxed">
                Best for individual advertisers or small teams needing quick, no-setup access without branding
                requirements.
              </p>
            ...
            <div className="bg-navy-800 rounded-2xl border border-navy-700 p-8">
              ...
              <p className="text-navy-300 text-sm mb-6 leading-relaxed">
                Best for agencies, networks, and startups wanting branded programmatic capabilities with margin control.
              </p>
              <ul className="space-y-3">
                {[
      ...
      <section className="py-12 md:py-16 bg-navy-800 relative overflow-hidden">
        ...
        >
          ...
          <p className="text-xl text-navy-300 mb-4 leading-relaxed">
            Not sure which approach fits your business? Talk to our team for a personalized recommendation.
          </p>
