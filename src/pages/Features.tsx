...
const targetingFeatures = [
  ...
  },
  {
    ...
    description: "Country, state, city, DMA, zip code, and radius targeting.",
    icon: MapPin,
  },
  {
  ...
  {
    title: "Time & Day Targeting",
    description: "Schedule campaigns for specific hours and days of the week.",
    icon: Clock,
  },
  {
...
const platformFeatures = [
  ...
  },
  {
    title: "Brand Safety",
    description:
      "Domain-level exclusions, pre-bid fraud filtering, viewability verification, and third-party integrations.",
    icon: Shield,
  },
  {
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Demographic, geographic, behavioral, contextual, device, time-of-day, first-party data onboarding, and third-party audience segments.",
  },
  {
    question: "How does real-time bidding work?",
    answer:
      "Our RTB engine processes millions of bid requests per second, evaluating each impression against your campaign criteria and optimizing for your chosen KPIs.",
  },
  {
    question: "Is reporting customizable?",
    answer:
      "Yes. View performance by creative, placement, audience, device, geography, and time period. Export in customizable formats with white-label branding.",
  },
];
...
const Features = () => {
  ...
  useEffect(() => {
    ...
    if (meta)
      meta.setAttribute(
        "content",
        "Explore the full feature set of PublifyX DSP — advanced targeting, real-time bidding, multi-channel support, brand safety, transparent reporting, and white label customization.",
      );
    return () => {
            ...
            >
              <div className="relative">
                ...
                <img
                  ...
                  alt="Platform features dashboard showing targeting controls, real-time bidding metrics, and multi-channel campaign management"
