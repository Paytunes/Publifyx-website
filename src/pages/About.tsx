...
const whatWeDo = [
  { title: "White Label DSP Technology", description: "A fully functional, branded demand side platform supporting display, video, audio, CTV, and OTT.", icon: Lightbulb },
  { title: "Infrastructure & Bidding", description: "We handle real-time bidding engine, server architecture, data pipelines, and ongoing compliance.", icon: Zap },
  { title: "Supply Integrations", description: "40+ SSP and ad exchange connections pre-configured. Custom integrations available.", icon: Globe },
  { title: "Ongoing Support", description: "Ad tech specialists guide you through setup, optimization, and campaign strategy.", icon: Handshake },
];

const whoWeServe = [
  { title: "Independent Media Agencies", description: "Bring programmatic in-house, eliminate middlemen, and increase margins with your own branded platform.", icon: Building2 },
  ...
  { title: "Performance Companies", description: "Run data-driven campaigns across multiple channels with advanced targeting and real-time optimization.", icon: Target },
  { title: "Startups", description: "Enter the ad tech market without millions in development costs. Launch your own DSP in days.", icon: Star },
];

const values = [
  { title: "Transparency", description: "Clear pricing, honest communication, and full visibility into how your platform operates." },
  { title: "Accessibility", description: "Enterprise-grade ad tech should not require enterprise-grade budgets. We make it accessible." },
  { title: "Partnership", description: "We succeed when you succeed. Our support goes beyond technology into business strategy." },
  { title: "Innovation", description: "Continuous platform updates, new features, and expanded integrations to keep you competitive." },
];
  ...
  return (
    <Layout transparentHeader>
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-navy-800">
        ...
        <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-brand-orange-300 rounded-full blur-[160px] opacity-[0.06]" />
         <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <PageBreadcrumb items={[{ label: "Home", path: "/" }, { label: "Resources", path: "/resources" }, { label: "About" }]} />
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
              ...
              <p className="text-lg md:text-xl text-navy-200 mb-4 leading-relaxed max-w-xl">
                We build white-labeled DSP technology that enables agencies, ad networks, and startups to launch their own branded programmatic platforms — without building from scratch.
              </p>
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <motion.span initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="inline-block text-sm font-semibold text-brand-orange-500 uppercase tracking-widest mb-3">What We Do</motion.span>
            <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>Our Technology, Your Brand</motion.h2>
            <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="text-lg text-navy-400 max-w-3xl mx-auto mt-4 leading-relaxed">
              You deploy the platform under your brand, operate with your pricing, and manage clients independently — while we handle infrastructure, bidding technology, and updates.
            </motion.p>
          </div>
      ...
      <section className="py-20 md:py-28 bg-navy-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <motion.span initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="inline-block text-sm font-semibold text-brand-orange-500 uppercase tracking-widest mb-3">Our Approach</motion.span>
            <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>What Drives Us</motion.h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
            {values.map((value, i) => (
              <motion.div key={value.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.08 }}>
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <motion.span initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="inline-block text-sm font-semibold text-brand-orange-500 uppercase tracking-widest mb-3">Who We Serve</motion.span>
            <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>Our Clients</motion.h2>
          </div>
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl border border-navy-100 p-6 md:p-8">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link to="/case-studies" className="text-sm bg-navy-50 border border-navy-200 rounded-lg px-4 py-2 text-navy-700 hover:border-brand-orange-500 hover:text-brand-orange-500 transition-colors">Case Studies</Link>
              <Link to="/contact" className="text-sm bg-navy-50 border border-navy-200 rounded-lg px-4 py-2 text-navy-700 hover:border-brand-orange-500 hover:text-brand-orange-500 transition-colors">Contact Us</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28 bg-navy-800 relative overflow-hidden">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl text-navy-300 mb-4 leading-relaxed">Ready to explore how we can power your programmatic advertising business?</p>
